...
// monaco cdn path
// AliCDN https://g.alicdn.com/code/lib/monaco-editor/0.51.0/min/vs/editor/editor.main.js
...
// locale
export const locale =
  navigator.language.toLowerCase().indexOf('zh') > -1 ? 'zh-CN' : 'en';
...
// theme names
export const themeNames: themeType = [
  'active4d',
  'clouds',
  'chrome',
  'monokai',
